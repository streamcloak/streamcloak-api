...
## How it Works
The application exposes an HTTP API that allows the client app to trigger system-level operations on the Raspberry Pi. Instead of direct SSH access, the app sends requests to this endpoint to manage settings securely.
